<template>
  <div class ="header">
      <div class="nav">
            ...
            <a href=""> <div class="bookmark-icon">
            ...
            <a href=""> <div class="lists-icon">
                <svg viewBox="0 0 24 24"><g><path d="M19.75 2H4.25C3.013 2 2 3.013 2 4.25v15.5C2 20.987 3.013 22 4.25 22h15.5c1.237 0 2.25-1.013 2.25-2.25V4.25C22 3.013 20.987 2 19.75 2zM11 16.75H7c-.414 0-.75-.336-.75-.75s.336-.75.75-.75h4c.414 0 .75.336.75.75s-.336.75-.75.75zm6-4H7c-.414 0-.75-.336-.75-.75s.336-.75.75-.75h10c.414 0 .75.336.75.75s-.336.75-.75.75zm0-4H7c-.414 0-.75-.336-.75-.75s.336-.75.75-.75h10c.414 0 .75.336.75.75s-.336.75-.75.75z"></path></g></svg>
            </div> </a>
            ...
            <a href=""> <div class="compose-tweet">
...
.header{
    ...
    position: fixed;
    height: 100vh;
    width: calc((100vw - var(--tweet-content-width-l) )/ 2.25);
    left: 0;
    ...
    .nav{
        ...
        .compose-tweet{
            width: 47px;
            height: 47px;
            background-color:$twitter-default;
        }
    }
}
</style>